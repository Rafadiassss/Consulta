...
public class ConsultaModelAssembler implements RepresentationModelAssembler<ConsultaVO, EntityModel<ConsultaVO>> {
        ...
        public EntityModel<ConsultaVO> toModel(ConsultaVO consultaVO) {
                ...
                consultaModel
                                .add(linkTo(methodOn(ConsultaController.class).atualizar(consultaVO.id(), null))
                                                .withRel("update"));
                consultaModel.add(
                                linkTo(methodOn(ConsultaController.class).deletar(consultaVO.id())).withRel("delete"));
