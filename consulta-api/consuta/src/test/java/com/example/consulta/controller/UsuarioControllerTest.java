...
class UsuarioControllerTest {
    ...
    @BeforeEach
    void setUp() {
        medicoVO = new UsuarioVO(1L, "Dra. Ana", "ana.med", null, null, null, "medico", "12345-SP", "Cardiologia",
                null, null);
        pacienteVO = new UsuarioVO(2L, "Carlos Souza", "carlos.s", null, null, null, "paciente", null, null,
                "111.222.333-44", "asasasasasa");

        medicoRequestDTO = new MedicoRequestDTO("Dra. Ana", "ana.med", "senha", "ana@email.com", null, "12345-SP", 1L);
        pacienteRequestDTO = new PacienteRequestDTO("Carlos Souza", "carlos.s", "senha", null, null,
