...
class SecretariaControllerTest {
        ...
        void setUp() {
                ...
                // validação @CPF.
                String cpfValidoParaTeste = "705.503.340-97"; // Geradores online podem fornecer CPFs válidos para
                                                              // teste.

                secretariaVO = new SecretariaVO(1L, "Ana Silva", cpfValidoParaTeste, "11987654321", "ana@email.com",
                                "ana.silva");
                secretariaRequestDTO = new SecretariaRequestDTO("Ana Silva", cpfValidoParaTeste, "11987654321",
                                "ana@email.com",
                                "ana.silva", "senha123");
        ...
        void salvar_comEmailVazio() throws Exception {
                ...
                SecretariaRequestDTO dtoInvalido = new SecretariaRequestDTO("Nome Valido", "111.222.333-44", null, "",
                                "user",
                                "senha");
        ...
        void atualizar_quandoNaoEncontrado() throws Exception {
                when(secretariaService.atualizar(eq(99L), any(SecretariaRequestDTO.class)))
