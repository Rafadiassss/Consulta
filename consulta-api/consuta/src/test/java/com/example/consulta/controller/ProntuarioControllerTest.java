...
class ProntuarioControllerTest {
    ...
    // Dentro da sua classe ProntuarioControllerTest, adicione este novo método de
    // teste.
    ...
    void adicionarNovaEntrada_mantendoHistorico() throws Exception {
        ...
        // 1. Simula uma entrada antiga que já existe no prontuário.
        EntradaProntuario entradaAntiga = new EntradaProntuario();
        entradaAntiga.setDiagnostico("Diagnóstico antigo");

        // 2. Simula o prontuário como ele está no banco, já com a entrada antiga.
        ...
        // 3. Este é o objeto com as NOVAS informações que estamos enviando na
        // requisição.
        ...
        // 4. Prepara a resposta que esperamos do serviço: o prontuário com AMBAS as
        // entradas.
        ...
        // 5. Configura o mock do serviço para simular a lógica de adição.
